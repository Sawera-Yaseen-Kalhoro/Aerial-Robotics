...
class HeightControl:
    ...
    def __init__(self):
        ...
        self.pid_vz.set_kp(35)
        self.pid_vz.set_ki(3)
        self.pid_vz.set_kd(10)
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            # Outer loop: Compute velocity set point from position error
            vz_ref = self.pid_z.compute(self.z_sp , self.z_mv)

            # Inner loop: Compute motor speed from velocity error
            self.mot_speed = self.pid_vz.compute(vz_ref , self.vz_mv) + 650
